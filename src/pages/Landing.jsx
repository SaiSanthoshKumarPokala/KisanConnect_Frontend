    ...
    return (
        <>
                ...
                <div>
                    <div className="flex flex-col items-center justify-center h-[600px] gap-4">
                        ...
                        <div className="flex gap-8 m-4">
                            <button className="px-4 py-2 text-white font-bold rounded-xl m-2 border-gold/75 border-[1.2px] cursor-pointer bg-darkgreen
                             hover:bg-gradient-to-r hover:from-gold hover:to-yellow-200 hover:text-darkgreen transition-all ease-in duration-100">Get Started</button>
                            <button className="px-4 py-2 text-white font-bold rounded-xl m-2 border-white border-[1.2px] cursor-pointer hover:bg-white hover:text-gold hover:border-gold transition-all ease-in duration-100">Know more</button>
                        </div>
                    </div>
                </div>
            ...
            <div className="block md:hidden font-montserrat bg-[url(/hero.png)] bg-cover bg-center bg-darkgreen">
                ...
                <div>
                    <div className="flex flex-col items-center justify-center h-[600px] gap-4">
                        ...
                        <div className="flex flex-col items-center justify-center text-center px-4">
                            <p className="font-bold md:text-xl bg-gradient-to-r from-gold to-yellow-200 bg-clip-text text-transparent">We provide the resources and support  </p>
                            <p className="font-bold md:text-xl bg-gradient-to-r from-gold to-yellow-200 bg-clip-text text-transparent">to help you achieve your goals, season after season.</p>
                        </div>
                        <div className="flex gap-8 m-4">
                            ...
                            <button className="px-4 py-2 text-white font-bold rounded-xl m-2 border-white border-[1.2px] cursor-pointer">Know more</button>
                        </div>
                    </div>
                    <div className="relative bottom-0 h-20 bg-linear-to-b from-darkgreen/10 to-darkgreen">
                    </div>
            ...
            <div className="relative font-montserrat bg-darkgreen h-auto">
                <div className="pt-16 mb-8 flex gap-2 md:gap-4 items-center justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:w-11/12 m-auto w-9/12 py-6 justify-center ">
                    {
                        Services.map((item) => (
                            <div key={item.id} className="group border-gold border-1 rounded-3xl bg-black px-8 md:px-6 py-10 hover:bg-linear-to-br hover:from-gradstart hover:to-black hover:bg-darkgreen cursor-pointer">
                                <div className="flex flex-col gap-4 justify-between h-full">
                                    ...
                                    <div className="flex-col flex h-full justify-between gap-4">
                                        <ul className="text-lightblack font-semibold">
                                            <li className="flex flex-row gap-2 whitespace-pre-wrap"><CheckBadgeIcon className="fill-gold size-6" /> {item.point1}</li>
                                            <li className="flex flex-row gap-2 whitespace-pre-wrap"><CheckBadgeIcon className="fill-gold size-6" /> {item.point2}</li>
                                            <li className="flex flex-row gap-2 whitespace-pre-wrap"><CheckBadgeIcon className="fill-gold size-6" /> {item.point3}</li>
                                        </ul>
                                        <button className="px-4 py-2 flex items-center gap-2 border-1 w-fit rounded-lg border-gold text-gold cursor-pointer font-bold group-hover:bg-gold group-hover:text-white">Read More <ChevronRightIcon className="size-6 group-hover:hidden" /><ArrowLongRightIcon className="size-6 hidden group-hover:block" /> </button>
                                    </div>
                                </div>
                            </div>
                        ))
                ...
                <div className="flex items-center justify-center p-4">
                    <button className="px-4 py-2 text-white font-bold rounded-lg m-2 border-gold border-1 cursor-pointer hover:bg-white hover:text-gold transition-all ease-in duration-100">All Services</button>
                </div>
            </div>
            <div className="relative h-auto font-montserrat bg-darkgreen md:px-10 py-4">
                ...
                <h1 className="font-bold text-2xl md:text-4xl text-center m-6 text-white"><span className="text-3xl md:text-5xl">I</span>NSIDE THE <span className="bg-gradient-to-r from-gold to-yellow-200 bg-clip-text text-transparent">AI TOOL KIT</span></h1>
                <div className="flex flex-col md:flex-row m-auto justify-center-center p-4 w-11/12 md:w-11/12 lg:w-8/12 gap-1 md:gap-0.5">
                    <div className="flex flex-col w-full md:w-8/12 lg:w-6/12 bg-black rounded-md border-gold/70 border-1">
                        {
                            AIToolKit.map((item) => (
                                <div id={item.id} key={item.id} className={`flex flex-row items-center gap-4 p-4 cursor-pointer rounded-md ${isactive == item.id ? "bg-gradient-to-r from-gold to-yellow-200 text-black" : "bg-black text-white"}`} onClick={() => setIsactive(item.id)}>
                    ...
                    <div className="bg-black/42 border-1 border-gold/70 w-full rounded-md bg-[url(/ai_bg.png)] bg-cover bg-center">
                        <div className="flex flex-col p-6">
                            <h1 className="text-3xl pb-1.25 font-bold bg-gradient-to-r from-gold to-yellow-200 bg-clip-text text-transparent">{AIToolKit[isactive - 1].name}</h1>
                            ...
                            <ul className="text-white">
                                <li className="flex flex-row gap-4 items-center"><CheckIcon className="size-6 fill-activetab" /> {AIToolKit[isactive - 1].point1}</li>
                                <li className="flex flex-row gap-4 items-center"><CheckIcon className="size-6 fill-activetab" /> {AIToolKit[isactive - 1].point2}</li>
                                <li className="flex flex-row gap-4 items-center"><CheckIcon className="size-6 fill-activetab" /> {AIToolKit[isactive - 1].point3}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-[url(/farmer.png)] bg-cover bg-top font-montserrat bg-black relative">
                <div className="flex flex-col items-center justify-center text-center h-[443px] gap-4">
                    ...
                    <button className="px-4 py-2 text-white font-bold rounded-xl m-2 border-white border-[1.2px] cursor-pointer hover:bg-white hover:text-gold hover:border-gold transition-all ease-in duration-100">Join Now</button>
                </div>
            </div>
            <Footer />
        </>
