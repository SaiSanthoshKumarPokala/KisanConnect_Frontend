    ...
    return (
        <>
            <div className="h-dvh flex flex-col">
                <NavBar />
                <div className="h-dvh w-dvw m-auto items-center justify-evenly flex flex-col md:flex-row bg-white">
                    <div className="font-bold text-3xl text-darkgreen md:text-4xl lg:text-7xl flex flex-col items-center lg:items-start">
                        <p>It looks like</p>
                        <p>you are lost</p>
                        <p>in space</p>
