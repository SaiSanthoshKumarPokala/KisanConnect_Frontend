...
function AddStorageCard({ onAdd, hasStorages = false }) {
    ...
    >
      ...
      <div>
        <div style={{ fontSize: 18, fontWeight: 700, color: "#FFF085", marginBottom: 8 }}>
          {hasStorages ? "Add Another Storage" : "No Storages Yet"}
        </div>
        <div style={{ fontSize: 14, color: C.textMuted }}>
          {hasStorages
            ? "Create one more cold storage listing"
            : "Click here to add your first cold storage listing"}
        </div>
      </div>
    </div>
  );
        ...
        >
          {storages.length === 0 ? (
            <div style={{ maxWidth: 400, margin: "0 auto" }}>
              <AddStorageCard onAdd={onOpenForm} />
            </div>
            ...
            <div className="kc-grid">
              ...
              <AddStorageCard onAdd={onOpenForm} hasStorages={true} />
            </div>
          )}
        </div>
      </main>
